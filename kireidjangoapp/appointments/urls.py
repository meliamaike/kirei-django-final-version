...
urlpatterns = [ 
    ...
    path('booking/service/<int:service_id>/add_to_cart/', views.add_to_cart, name='add_to_cart'),
    path('booking/professional/<int:service_id>/', views.choose_professional, name='choose_professional'),
    path('booking/slot/<int:professional_id>/', views.choose_slot, name='choose_slot')
